                ...
                <Grid container style={{ marginTop: 20 }}>
                    <Grid item xs={10}>
                        ...
                        >
                            ...
                            <p>Please upload your ticket and put on sale from here!</p>

                            <Form onSubmit={this.onSubmit}>
                                <Field label="Ticekt NFT Name">
                                    <Input
                                        type="text"
                                        width={1}
                                ...
                                */}
                                ...
                                <Field label="Ticket Price (unit: ETH)">
                                    <Input
                                        type="text"
                                        width={1}
                                        placeholder="e.g) 10"
                                ...
                                <Field label="Ticket for uploading to IPFS">
                                    <input 
                                        type='file' 
                                ...
                                <Button size={'medium'} width={1} type='submit'>Upload my ticket and put on sale</Button>
                            </Form>
                        </Card>
                    </Grid>
